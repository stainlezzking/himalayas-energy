export const AboutMetaData = {
  ...
  description:
    "Learn about Himalayas Energy Consults Limited, our mission, vision, and values. With over six years of experience, we are a leader in Nigeria’s oil and gas industry. We specialize in exploration, production, EPCC, and gas distribution.",
  keywords: [
    "About Himalayas Energy",
    "Oil and Gas Company Nigeria",
    "Energy Sector Leadership",
    "Oil and Gas Exploration",
    "Himalayas Energy Team",
    "Oil Field Experts",
  ],
  openGraph: {
    type: "website",
  ...
  twitter: {
    ...
    title: "About Himalayas Energy Consults Limited | Oil & Gas Experts",
    description:
