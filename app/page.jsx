    ...
    <>
      ...
      <section className="relative py-[55px] pageMargin grid grid-cols-12 justify-between gap-x-10 items-center">
        ...
        <div className="space-y-6 col-span-5 max-w-[430px]">
          ...
          <div className="space-y-16">
            <p>
              ...
              & Gas industry. Himalayas Energy is currently looking to spread its tentacles into the exploration and production terrain with its
        ...
        <div className="col-span-7 relative aspect-square ">
          ...
          <Image src={whoAreWe2} width="554" height="462" className="w-[80%] aspect-square absolute top-0 right-0" />
        </div>
      </section>
      <div className="bg-[#EFF0F3] ">
        <section className="py-[120px] pageMargin relative">
          <span className="block absolute top-16 -left-5">
