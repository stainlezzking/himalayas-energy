        ...
        <div className="pageMargin">
          ...
          <div className="relative gap-x-6 items-center">
            ...
            <div className="space-y-3 ps-6 w-[630px] max-w-full">
              ...
              <h1 className="text-2xl sm:text-4xl font-bold">Innovating for a Sustainable Energy Future in Africa</h1>
            </div>
          </div>
        </div>
          ...
          <ul className="space-y-[62px]">
            ...
            <li className="space-y-3">
              ...
              <span className="flex flex-wrap gap-x-2 items-center text-body1">
                ...
                <span className="font-medium text-main shrink-0">Oil Field Assessment:</span> Assessing the volume of oil and gas in the reservoir.
              </span>
              <span className="flex gap-x-2 items-center text-body1">
                <svg width="13" height="14" viewBox="0 0 13 14" fill="none" className="block shrink-0">
                  <circle cx="6.5" cy="7" r="4.5" fill="white" stroke="#C00000" strokeWidth="4" />
